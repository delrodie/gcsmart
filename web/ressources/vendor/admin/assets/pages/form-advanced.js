...
! function(e) {
    ...
    t.prototype.init = function() {
            jQuery("#timepicker").timepicker({ defaultTIme: !1 }), jQuery("#timepicker2").timepicker({ showMeridian: !1 }), jQuery("#timepicker3").timepicker({ minuteStep: 15 }),
                ...
                e(".colorpicker-rgba").colorpicker(), jQuery("#datepicker").datepicker(), jQuery("#datepicker-autoclose").datepicker({ autoclose: !0, todayHighlight: !0 }), jQuery("#datepicker-inline").datepicker(), jQuery("#datepicker-multiple-date").datepicker({ format: "yyyy/dd/mm", clearBtn: !0, multidate: !0, multidateSeparator: "," }), jQuery("#date-range").datepicker({ toggleActive: !0 }),
