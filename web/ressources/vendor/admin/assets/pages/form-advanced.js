...
! function(e) {
    ...
    t.prototype.init = function() {
            jQuery("#timepicker").timepicker({ defaultTIme: !1 }), jQuery("#timepicker2").timepicker({ showMeridian: !1 }), jQuery("#timepicker3").timepicker({ minuteStep: 15 }),
                ...
                jQuery("#datepicker-multiple-date").datepicker({ format: "yyyy/dd/mm", clearBtn: !0, multidate: !0, multidateSeparator: "," }),
                jQuery("#date-range").datepicker({ toggleActive: !0 }),
                e("input#defaultconfig").maxlength(),
                e("input#thresholdconfig").maxlength({ threshold: 20 }),
                ...
                e("input#appbundle_agent_matricule").maxlength({ alwaysShow: !0, placement: "top-left" }),
                e("input#appbundle_agent_nom").maxlength({ alwaysShow: !0, placement: "top-left" }),
                e("input#appbundle_agent_prenoms").maxlength({ alwaysShow: !0, placement: "top-left" }),
                e("input#appbundle_agent_cni").maxlength({ alwaysShow: !0, placement: "top-left" }),
                e("input#appbundle_agent_lieunaiss").maxlength({ alwaysShow: !0, placement: "top-left" }),
                e("input#appbundle_agent_email").maxlength({ alwaysShow: !0, placement: "top-left" }),
                ...
                e("input#appbundle_rechagent_matricule").maxlength({ alwaysShow: !0, placement: "top-left" }),
                e("input#appbundle_rechagent_pass").maxlength({ alwaysShow: !0, placement: "top-left" }),
                ...
                e("input[name='demo3_21']").TouchSpin({ initval: 40 }),
                e("input[name='demo3_22']").TouchSpin({ initval: 40 }),
                e("input[name='demo5']").TouchSpin({ prefix: "pre", postfix: "post" }),
