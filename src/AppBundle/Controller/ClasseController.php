...
class ClasseController extends Controller
{
     ...
     *
     * @Route("/new", name="admin_classe_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('notice', "La classe ".$classe->getLibelle()." a été créée avec succès.!");
     ...
     *
     * @Route("/{id}", name="admin_classe_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{slug}/edit", name="admin_classe_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Classe $classe)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            $this->addFlash('notice', "La classe ".$classe->getLibelle()." a été modifiée avec succès.!");
     ...
     *
     * @Route("/{id}", name="admin_classe_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm(Classe $classe)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_classe_delete', array('id' => $classe->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
